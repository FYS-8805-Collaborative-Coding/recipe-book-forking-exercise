...
Step 1: Prepare the chickpea mixture
    ...
    Finally, mix the baking soda, salt and cumin into the mixture, cover the bowl and place it in the refrigerator for at least an hour - up to 2 days.

Step 2: Turn the falafel into balls

    Mix in most of the sesame seeds (keep a little on the side) and gradually add enough water so that the mixture can be formed into a ball that holds together loosely. It shouldn't be too wet – just enough to form a loosely shaped patty.
    Roll the cooled mixture into small balls. If you want to look like a professional or you love making falafels quite often, you can use a special falafel tool to shape them.
    Dip the falafels in the remaining sesame seeds if you want something extra.

Step 3: Fry the falafel and serve

    Heat the sunflower oil in a pan and fry the falafel until it turns golden brown (about 2 minutes).
